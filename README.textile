...
p. Digests such as @gost@, @md2@, @md4@, @md5@, @ripemd128@, @ripemd160@, @ripemd256@, @ripemd320@, @sha1@, @sha224@, @sha256@, @sha384@, @sha512@, @sha3@, @tiger@, @whirepool@. All functions expect an byte-array as input and return a new byte-array as output. Have a look at the "tests":https://github.com/sebhoss/bc-clj/blob/master/src/test/clojure/com/github/sebhoss/bouncycastle/digest_test.clj to see how these functions work.
...
bc. [com.github.sebhoss/bc-clj "[1.0.1,2.0.0)"]
