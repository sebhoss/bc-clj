...
p. Provides @(generate-key)@ which needs an algorithm-name and optionally the key-strength in bit. The "tests":https://github.com/sebhoss/bc-clj/blob/master/src/test/clojure/bouncycastle/key_generator_test.clj show how to use the function.
